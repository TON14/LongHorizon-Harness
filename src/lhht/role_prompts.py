...
LHHT_MANAGER_INSTRUCTIONS = MANAGER_INSTRUCTIONS["en"]
LHHT_GUI_EXECUTOR_INSTRUCTIONS = GUI_EXECUTOR_INSTRUCTIONS["en"]
LHHT_CLI_EXECUTOR_INSTRUCTIONS = CLI_EXECUTOR_INSTRUCTIONS["en"]
LHHT_GUI_AUDITOR_INSTRUCTIONS = GUI_AUDITOR_INSTRUCTIONS["en"]
LHHT_CLI_AUDITOR_INSTRUCTIONS = CLI_AUDITOR_INSTRUCTIONS["en"]
