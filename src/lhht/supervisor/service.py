...
class RunSupervisor:
    ...
    def _is_alive(self, run_id: str) -> bool:
        ...
        # In particular, ``lhht run --dashboard`` generates its run id
    ...
    def _launch_worker(
        ...
        *,
        ...
        # supplied through ``LHHT_WEB_TOKEN`` and must not be inherited by
        ...
        worker_env.pop("LHHT_WEB_TOKEN", None)
    ...
    def attach_run(
        ...
        *,
        ...
        ``lhht run --dashboard`` owns its own process, so there is no
