...
_CODEX_BINARY_ENV_VARS = ("LHHT_CODEX_BINARY", "CODEX_CLI_PATH")
_DSH_BINARY_ENV_VAR = "LHHT_DSH_BINARY"
_OPENCODE_BINARY_ENV_VAR = "LHHT_OPENCODE_BINARY"
_ZCODE_BINARY_ENV_VAR = "LHHT_ZCODE_BINARY"
