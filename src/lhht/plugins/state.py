...
generated MCP configs live under `~/.lhht/plugins/`. Each install writes
...
`lhht run` picks the highest-priority installed plugin for the agent it is
...
def plugins_root() -> Path:
    root = os.environ.get("LHHT_STATE_ROOT") or DEFAULT_STATE_ROOT
